...
Complete guide to deploying the REFLEKT monorepo projects on Vercel with GitHub integration.

## Overview

All REFLEKT projects are deployed on Vercel with automatic deployments triggered by GitHub commits. Each project in the monorepo has its own Vercel project with specific configurations.

## Projects Structure

| Project | URL | Vercel Project | Root Directory |
|---------|-----|---------------|----------------|
| Apps (Main) | [reflekt.sh](https://reflekt.sh) | `reflekt-ai` | `/` |
| Console | [console.reflekt.sh](https://console.reflekt.sh) | `console` | `/` |
| Docs | [docs.reflekt.sh](https://docs.reflekt.sh) | `docs-nextra` | `/` |
| Credit Engine | [credit.reflekt.sh](https://credit.reflekt.sh) | `credit-engine` | `/` |
...
# Authentication
NEXTAUTH_URL=https://credit.reflekt.sh
...
```bash
# Apps
reflekt.sh → reflekt-ai.vercel.app

# Console
console.reflekt.sh → console.vercel.app

# Docs
docs.reflekt.sh → docs-nextra.vercel.app

# Credit Engine
credit.reflekt.sh → credit-engine.vercel.app
```
...
NEXT_PUBLIC_API_URL=https://api.reflekt.sh

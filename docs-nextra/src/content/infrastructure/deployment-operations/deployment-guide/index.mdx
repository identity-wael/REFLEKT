...
Step-by-step guide for deploying REFLEKT projects from development to production.

## Deployment Overview

The REFLEKT platform uses a multi-stage deployment pipeline with automatic deployments via Vercel's GitHub integration.
...
```
https://console-[hash]-reflekt-ai.vercel.app
```
...
curl -I https://console.reflekt.sh
```
...
curl https://console.reflekt.sh/api/health

# Apps health check
curl https://reflekt.sh/api/health

# Credit Engine health check
curl https://credit.reflekt.sh/api/health
```
...
# Lighthouse CI
pnpm add -D @lhci/cli
lhci autorun --collect.url=https://console.reflekt.sh

# Load testing
pnpm add -D autocannon
autocannon -c 10 -d 30 https://console.reflekt.sh/api/health
```
...
# URLs:
# - https://reflekt.sh
# - https://console.reflekt.sh
# - https://docs.reflekt.sh
# - https://credit.reflekt.sh
```

...
Quick reference for all ports, URLs, and configurations in the REFLEKT monorepo.
...
|---------|---------------|----------|
| **Apps** | https://reflekt.sh | Vercel |
| **Console** | https://console.reflekt.sh | Vercel |
| **Docs** | https://docs.reflekt.sh | Vercel |
| **Credit Engine** | https://credit.reflekt.sh | Vercel |
...
|-----------|-------------|----------------|
| apps/ | reflekt-ai | `--filter=reflekt-ai` |
...
|---------|--------------|-----------------|
| **Apps** | `pnpm turbo build --filter=reflekt-ai` | `pnpm install` |

...
The REFLEKT platform uses a monorepo structure to manage multiple related applications and services. This guide outlines best practices for working within our monorepo.
...
{
  "dependencies": {
    "@reflekt/shared": "workspace:*",
    "@reflekt/ui": "workspace:^"
  }
}
```
...
import { utils } from '@reflekt/shared'
...
// apps/tsconfig.json
{
  "extends": "@reflekt/tsconfig/nextjs.json",
  "compilerOptions": {
    "baseUrl": "."
  }
}
...
- Apps → app.reflekt.ai
- Console → console.reflekt.ai
- Docs → docs.reflekt.ai

...
> **Note**: Credit Engine is part of the Earna AI monorepo and uses Turborepo for build orchestration. Commands can be run from the monorepo root using `pnpm turbo --filter=credit-engine` or directly from the `credit-engine` directory.
...
- **GitHub**: [github.com/identity-wael/earna-ai](https://github.com/identity-wael/earna-ai)
- **Main Console**: [console.earna.sh](https://console.earna.sh)
- **Landing Page**: [earna.sh](https://earna.sh)

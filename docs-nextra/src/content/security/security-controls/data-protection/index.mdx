...
Data protection is a cornerstone of REFLEKT's security program, ensuring that sensitive customer data, financial information, and business-critical assets are properly classified, secured, and managed throughout their lifecycle. This document outlines our comprehensive data protection strategy aligned with SOC2 Type II requirements and Canadian privacy regulations.
...
- **Data Protection Officer**: dpo@reflekt.ai
- **Privacy Team**: privacy@reflekt.ai
- **Security Incident**: security-incident@reflekt.ai
- **Data Subject Requests**: privacy-requests@reflekt.ai

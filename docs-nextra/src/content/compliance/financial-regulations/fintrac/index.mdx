...
The Financial Transactions and Reports Analysis Centre of Canada (FINTRAC) is Canada's financial intelligence unit and anti-money laundering (AML) and anti-terrorist financing (ATF) regulator. This document outlines REFLEKT's requirements and compliance obligations under the Proceeds of Crime (Money Laundering) and Terrorist Financing Act (PCMLTFA).
...
```mermaid
flowchart TD
    A[REFLEKT Services] --> B{MSB Activities?}
...
Based on REFLEKT's current business model:

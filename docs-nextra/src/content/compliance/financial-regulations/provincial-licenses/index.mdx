...
Each Canadian province and territory has its own financial services regulatory framework. This document outlines the licensing requirements for REFLEKT to operate legally across Canada, based on our services of financial data aggregation, credit assessment, and financial analytics.

## Service Classification by Province

```mermaid
graph TB
    subgraph "REFLEKT Services"
        S1[Data Aggregation]

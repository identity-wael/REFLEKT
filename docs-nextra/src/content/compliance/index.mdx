...
REFLEKT operates in the Canadian financial services sector, requiring compliance with federal and provincial regulations for financial technology services, anti-money laundering (AML), know your customer (KYC), and data privacy requirements.
...
graph TB
    ...
    subgraph "REFLEKT Compliance Program"
...
Based on our services, REFLEKT is classified as:
...
- **Privacy Officer**: privacy@reflekt.ai
- **Compliance Hotline**: compliance-hotline@reflekt.ai

...
- **Contributing**: See [CONTRIBUTING.md](https://github.com/identity-wael/earna-ai/blob/main/CONTRIBUTING.md)

## License

Earna AI Console is based on the open-source Zola project and enhanced with proprietary features. See [LICENSE](https://github.com/identity-wael/earna-ai/blob/main/LICENSE) for details.

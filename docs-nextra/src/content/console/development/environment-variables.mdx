...
Complete reference for configuring REFLEKT Console through environment variables.
...
SENTRY_ORG=your-org
SENTRY_PROJECT=reflekt-ai-console
...
NEXT_PUBLIC_APP_URL=https://console.reflekt.ai
```

---
title: Configuration
description: Configure REFLEKT Console with GPT-4o, alternative AI models, Supabase, and real-time features
---
...
Complete configuration guide for REFLEKT Console. This covers GPT-4o integration, alternative AI models via Vercel AI SDK v5, Supabase backend, HeyGen avatars, real-time voice features, and TypeScript strict mode.

## Environment Variables

REFLEKT Console requires several environment variables for proper operation. Create a `.env.local` file in your project root:
    ...
    export function createClient() {
      return createBrowserClient<Database>(
        ...
        process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,
        {
          ...
          global: {
            headers: {
              'x-application-name': 'reflekt-ai-console'
            }
          }
        }
      );
...
export const securityConfig = {
  ...
  cors: {
    origin: process.env.NODE_ENV === 'production'
      ? ['https://reflekt.sh', 'https://app.reflekt.sh']
...
For more help, see our [Troubleshooting Guide](/troubleshooting) or visit [GitHub Issues](https://github.com/reflekt-ai/console/issues).

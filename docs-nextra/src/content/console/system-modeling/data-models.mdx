...
This ER diagram shows the ACTUAL tables and relationships currently implemented in the REFLEKT Supabase database with Row Level Security (RLS).
...
This section details the Supabase-specific implementation and features used in the REFLEKT platform.
  ...
  <Tabs.Tab>
    **Plaid Integration Configuration:**
    ...
    const plaidConfig = {
      ...
      countryCodes: ['CA'],
      webhook: 'https://api.reflekt.ai/webhooks/plaid'
    };

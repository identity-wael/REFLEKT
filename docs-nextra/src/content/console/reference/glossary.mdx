---
title: Glossary
description: Technical terms and concepts used in REFLEKT Console
---
...
Technical terms, acronyms, and concepts used throughout REFLEKT Console documentation.
...
## REFLEKT Specific Terms

| Term | Definition |
|---|---|
| **Console** | The main chat application component of REFLEKT |

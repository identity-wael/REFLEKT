...
Comprehensive guides for upgrading REFLEKT Console and migrating between platforms.

## Version Information

<Callout type="info">
**Current Version**: REFLEKT Console is running on Vercel AI SDK v5 with full TypeScript strict mode support. See [AI SDK v5 Implementation](/console/development/ai-sdk-v5) for details.
</Callout>
...
<Callout type="info">
**Need Help?** If you encounter issues during migration, check our [Troubleshooting Guide](/operations/troubleshooting) or reach out on [Discord](https://discord.gg/reflekt-ai).
</Callout>

...
description: Monitor Earna AI Console performance, GPT-4o usage, and user engagement metrics
---
...
For monitoring support and custom dashboards, contact [support@earna.sh](mailto:support@earna.sh).
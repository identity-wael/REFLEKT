...
1. **Documentation**: [docs.earna.sh](https://docs.earna.sh)
2. **GitHub Issues**: [github.com/earna-ai/console/issues](https://github.com/earna-ai/console/issues)
3. **Discord Community**: [discord.gg/earna](https://discord.gg/earna)
4. **Email Support**: [support@earna.sh](mailto:support@earna.sh)

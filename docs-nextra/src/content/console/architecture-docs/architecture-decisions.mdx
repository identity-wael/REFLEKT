...
description: Key technical decisions and rationale behind REFLEKT Console design
---
...
This document records the key architectural decisions made for REFLEKT Console and the rationale behind them.
